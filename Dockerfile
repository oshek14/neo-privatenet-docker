...
WORKDIR /neo-python
RUN git clone https://github.com/novaknole/neo-python /neo-python
RUN pip3 install -e .
ADD https://api.github.com/repos/novaknole/neo-python/git/refs/heads/master version.json
RUN git pull https://github.com/novaknole/neo-python
